 ...
 * @author User
 */
@WebServlet(name = "ValetPickupServlet", urlPatterns = {"/ValetPickupServlet"})
public class ValetPickupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String isSuccess = vrDAO.driverReachedPickUpPoint(staffId, token, request_id);
        ...
        if (isSuccess.length() == 0) {
            session.setAttribute("isSuccess", "Pickup point reached for ID: " + request_id);
//            RequestDispatcher view = request.getRequestDispatcher("ViewRequest.jsp");
//            view.forward(request, response);
            SmsNotification smsNotification = new SmsNotification();
            smsNotification.smsForReached(custName, handphone);
...
//            view.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ValetPickupServlet.class.getName()).log(Level.SEVERE, null, ex);
