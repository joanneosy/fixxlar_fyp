 ...
 * @author User
 */
@WebServlet(name = "ValetOnTheWayServlet", urlPatterns = {"/ValetOnTheWayServlet"})
public class ValetOnTheWayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String isSuccess = vrDAO.driverOTWToDropOffPoint(staffId, token, request_id);
        ...
        if (isSuccess.length() == 0) {
            session.setAttribute("isSuccess", "On the way to dropoff point for ID: " + request_id);
...
//            view.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ValetOnTheWayServlet.class.getName()).log(Level.SEVERE, null, ex);
