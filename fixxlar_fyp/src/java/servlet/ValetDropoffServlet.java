 ...
 * @author User
 */
@WebServlet(name = "ValetDropoffServlet", urlPatterns = {"/ValetDropoffServlet"})
public class ValetDropoffServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String isSuccess = vrDAO.completeRequest(staffId, token, request_id);
        ...
        if (isSuccess.length() == 0) {
            session.setAttribute("isSuccess", "Dropoff point reached for ID: " + request_id);
//            RequestDispatcher view = request.getRequestDispatcher("ViewRequest.jsp");
//            view.forward(request, response);
            SmsNotification smsNotification = new SmsNotification();
            smsNotification.smsForArrivingAtWorkshop(custName, handphone);
...
//            view.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ValetDropoffServlet.class.getName()).log(Level.SEVERE, null, ex);
