...
//            view.forward(request, response);
            ...
            smsNotification.smsForFinalQuotation(custName, handphone, workshopName, price);
...
//            view.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddFinalQuotationServlet.class.getName()).log(Level.SEVERE, null, ex);
