...
public class Settings {
    ...
    public JsonObject retrieveSettingById(int staffId, String token, int settingId) throws UnsupportedEncodingException, IOException, ParseException {
        ...
        if (ele.isJsonNull()) {
            ...
            if (!attElement.isJsonNull()) {
                valueStr = attElement.getAsString();
                value = (JsonObject) jsonParser.parse(valueStr).getAsJsonObject();
            }
            return value;
        }
    }
    ...
    public HashMap<String, JsonObject> retrieveAllSettings(int staffId, String token) throws UnsupportedEncodingException, IOException, ParseException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            JsonElement attElement = obj.get("name");
            String name = "";
            if (!attElement.isJsonNull()) {
                name = attElement.getAsString();
            }

            attElement = obj.get("id");
            int id = 0;
            if (!attElement.isJsonNull()) {
                id = attElement.getAsInt();
            }
    ...
    public String editSetting(int staffId, String token, int settingId, JsonObject value) throws UnsupportedEncodingException, IOException {
    ...
    public String addSetting(int staffId, String token, String name, JsonObject value) throws UnsupportedEncodingException, IOException {
...
//        JsonArray arr = jobj.getAsJsonObject("payload").getAsJsonArray("settings");
    ...
    public static void main(String[] args) throws IOException, UnsupportedEncodingException, ParseException {
        ...
        for (Map.Entry<String, JsonElement> entry : entrySet) {
                ...
                System.out.println(entry.getValue().getAsInt());
...
//        retrieveSettings(1, "", 2);
